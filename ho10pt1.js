...
var passwordCheckOld = function () 
{
  ...
  //iterate through array to see if it is a bad password
  
for(i=0; i< arrayBadPasswords.length; i++)
{
    var passwordval = arrayBadPasswords[i];
    
    if(stringPassword == passwordval || stringPassword.length < 8)
    {
        
        alert("ERROR: your password is terrible");
        break;
    }
