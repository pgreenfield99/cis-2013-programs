...
{
	var floatCircArea = parseFloat( Math.PI * floatRadius_par * floatRadius_par);
...
var calcRectArea = function()
{
    var floatRectWidth = parseFloat($("rect_width").value);
	var floatRectHeight = parseFloat($("rect_height").value);
    alert ("The Rectangle area is " + rectangleArea(floatRectWidth, floatRectHeight));
};

function rectangleArea(floatRectHeight_par, floatRectWidth_par)
{
	var floatRectangleArea = parseFloat(floatRectHeight_par * floatRectWidth_par);
	return floatRectangleArea.toFixed(2);
}
...
var calcRectPerim = function()
{
    var floatRectWidth = parseFloat($("rect_width").value);
	var floatRectHeight = parseFloat($("rect_height").value);
    alert ("The Rectangle perimeter is " + rectanglePerim(floatRectWidth, floatRectHeight));
};

function rectanglePerim(floatRectHeight_par, floatRectWidth_par)
{
	var floatRectanglePerim = parseFloat(floatRectHeight_par + floatRectWidth_par + floatRectHeight_par + floatRectWidth_par);
	return floatRectanglePerim.toFixed(2);
}
